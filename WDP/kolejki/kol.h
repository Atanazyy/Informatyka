...
struct interesant {
    ...
    int num; //numerek interesanta
    interesant *sas1, *sas2; //wskazniki na interesantow stajacych obok w kolejce, jezeli jest to sztuczny poczatek lub koniec to sas1 = NULL 
    // A kończy tu
};
